...
/*
 * The __stack_chk_fail(void) function is called when a modified canary is
 * detected.
 */
...
/*
 * This function gets called at startup as part of construction of static C++
 * objects and is a way to programatically initialize the __stack_chk_guard when
 * the system starts.
 */
